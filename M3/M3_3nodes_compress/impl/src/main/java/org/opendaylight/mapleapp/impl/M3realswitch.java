...
public class M3realswitch extends MapleAppBase {

	private static final int REAL_IP1   = IPv4.toIPv4Address("192.168.0.13");
	private static final int REAL_IP2   = IPv4.toIPv4Address("192.168.0.14");
	private static final int VIRTUAL_IP = IPv4.toIPv4Address("192.168.0.7");

	private static final long REAL_MAC1 = Ethernet.toLong(Ethernet.toMACAddress("28:d2:44:26:1f:d2"));
	//private static final long REAL_MAC2 = Ethernet.toLong(Ethernet.toMACAddress(""));
	//private static final long REAL_MAC1   = Ethernet.toLong(Ethernet.toMACAddress("00:00:00:00:00:03"));
	private static final long REAL_MAC2   = Ethernet.toLong(Ethernet.toMACAddress("00:00:00:00:00:04"));
	...
	private void forwardToRIP(MaplePacket pkt, int srcIP, int rIP, long rMAC) {
		...
		// Set packet header modification action
		pkt.setIPv4Dst(rIP);
		pkt.setEthDst(rMAC);
